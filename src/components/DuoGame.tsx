...
export default function DuoGame({ roomId, seat }: DuoGameProps) {
  ...
  const DuoClient = useMemo(() => {
    ...
    // This device drives ONLY its own seat; every other seat — including
    // bots — renders as remote here (bot turns run on the headless client
    // in the "bot turns" effect above and get published like any move).
